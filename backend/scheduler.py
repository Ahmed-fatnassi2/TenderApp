...
#     # For testing - run at current time + 1 minute
#     # Uncomment the line below and set your desired time
#     # schedule.every().day.at("10:25").do(send_daily_digest)
    
#     logger.info("⏰ Daily scheduler configured - will run at 8:00 AM Tunisian time")
